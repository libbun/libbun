...
public class VBAGenerator extends LibBunSourceGenerator {

	public VBAGenerator() {
		super(new LibBunLangInfo("Visiual Basic for Applications 7.0", "vba"));
	...
	@Override public void VisitAndNode(BunAndNode Node) {
		this.GenerateBinaryOperatorExpression(Node, "AndAlso");
	}

	@Override public void VisitOrNode(BunOrNode Node) {
		this.GenerateBinaryOperatorExpression(Node, "OrElse");
	}
	...
	@Override public void VisitModNode(BunModNode Node) {
		this.GenerateBinaryOperatorExpression(Node, "Mod");
	}
	...
	@Override public void VisitBitwiseXorNode(BunBitwiseXorNode Node) {
		this.GenerateBinaryOperatorExpression(Node, "Xor");
	}
