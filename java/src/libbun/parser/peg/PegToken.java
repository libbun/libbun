...
public class PegToken {
	...
	public PegToken(PegSource Source, int StartIndex, int EndIndex) {
		this.Source = Source;
	...
	public final PegContext newParserContext(PegParser parser) {
		return new PegContext(parser, this.Source, this.StartIndex, this.EndIndex);
	}

	public final PegContext newParserContext(PegParser parser, int startIndex) {
		return new PegContext(parser, this.Source, this.StartIndex + startIndex, this.EndIndex);
	}
