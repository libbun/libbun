...
public class CodeNode extends AstNode {
	...
	public CodeNode(AstNode ParentNode, String LibName, String FormText, BType FormType) {
		super(ParentNode, 2);
	...
	@Override public AstNode dup(boolean typedClone, AstNode ParentNode) {
		return this.dupField(typedClone, new CodeNode(ParentNode, this.RequiredLibrary, this.FormText, this.FormType));
	}
	...
	public final BType FormType() {
		if(this.FormType == null) {
			this.FormType = this.AST[CodeNode._TypeInfo].Type;
		}
	...
	public final String GetFormText() {
		if(this.FormText == null) {
			@Var AstNode Node = this.AST[CodeNode._Form];
