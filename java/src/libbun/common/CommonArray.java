...
public class CommonArray<T> {
	@BField private int    Size;
	@BField public T[] ArrayValues;

	public CommonArray(T[] Values) {
		this.ArrayValues = Values;
		this.Size = 0;
	}

	@SuppressWarnings("unchecked")
	public CommonArray(int TypeId, T[] Values) {
	...
	public final static<T> T GetIndex(CommonArray<T> a, long Index) {
	...
	public final static<T> void SetIndex(CommonArray<T> a, long Index, T Value) {
		if(!(0 <= Index && Index < a.Size)) {
			CommonArray.ThrowOutOfArrayIndex(a.Size, Index);
		}
